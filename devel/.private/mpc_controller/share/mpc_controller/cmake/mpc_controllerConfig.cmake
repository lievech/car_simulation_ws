...
if("TRUE" STREQUAL "TRUE")
  set(mpc_controller_SOURCE_PREFIX /home/lhn/hhh_ws/src/mpc_controller)
  set(mpc_controller_DEVEL_PREFIX /home/lhn/hhh_ws/devel/.private/mpc_controller)
  ...
  set(mpc_controller_INSTALL_PREFIX /home/lhn/hhh_ws/install)
...
if(NOT "/home/lhn/hhh_ws/src/mpc_controller/include " STREQUAL " ")
  set(mpc_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/lhn/hhh_ws/src/mpc_controller/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'yt <yt@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lhn/hhh_ws/src/mpc_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lhn/hhh_ws/devel/.private/mpc_controller/lib;/home/lhn/hhh_ws/devel/lib;/home/lhn/dev/catkin_ws/install/lib;/home/lhn/dev/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "roscpp;std_msgs;nav_msgs;tf;dbw_mkz_msgs;anm_msgs")
foreach(depend ${depends})
  ...
  list(APPEND mpc_controller_EXPORTED_TARGETS ${${mpc_controller_dep}_EXPORTED_TARGETS})
endforeach()

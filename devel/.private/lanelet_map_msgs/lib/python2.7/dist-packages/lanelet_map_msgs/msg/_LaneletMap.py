...
class LaneletMap(genpy.Message):
  _md5sum = "47744b3c77f251cfd1066f1c31dff1cf"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.left_beside.left_bound.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.left_beside.left_bound.points:
        ...
        _x = _v10
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.left_beside.right_bound.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.left_beside.right_bound.points:
        ...
        _x = _v11
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.left_beside.centerline.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.right_beside.left_bound.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.right_beside.left_bound.points:
        ...
        _x = _v15
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.right_beside.right_bound.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.right_beside.right_bound.points:
        ...
        _x = _v16
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.right_beside.centerline.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v47.type = str[start:end].decode('utf-8')
        else:
          _v47.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v47.points = []
        ...
        if python3:
          _v49.type = str[start:end].decode('utf-8')
        else:
          _v49.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v49.points = []
        ...
        if python3:
          _v51.type = str[start:end].decode('utf-8')
        else:
          _v51.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v51.points = []
      ...
      if python3:
        self.left_beside.left_bound.type = str[start:end].decode('utf-8')
      else:
        self.left_beside.left_bound.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.left_beside.right_bound.type = str[start:end].decode('utf-8')
      else:
        self.left_beside.right_bound.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.left_beside.centerline.type = str[start:end].decode('utf-8')
      else:
        self.left_beside.centerline.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.right_beside.left_bound.type = str[start:end].decode('utf-8')
      else:
        self.right_beside.left_bound.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.right_beside.right_bound.type = str[start:end].decode('utf-8')
      else:
        self.right_beside.right_bound.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.right_beside.centerline.type = str[start:end].decode('utf-8')
      else:
        self.right_beside.centerline.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v66.type = str[start:end].decode('utf-8')
        else:
          _v66.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v66.points = []
        ...
        if python3:
          _v68.type = str[start:end].decode('utf-8')
        else:
          _v68.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v68.points = []
        ...
        if python3:
          _v70.type = str[start:end].decode('utf-8')
        else:
          _v70.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v70.points = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v75.type = str[start:end].decode('utf-8')
        else:
          _v75.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v75.points = []
        ...
        if python3:
          _v77.type = str[start:end].decode('utf-8')
        else:
          _v77.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v77.points = []
        ...
        if python3:
          _v79.type = str[start:end].decode('utf-8')
        else:
          _v79.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v79.points = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v84.type = str[start:end].decode('utf-8')
        else:
          _v84.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v84.points = []
        ...
        if python3:
          _v86.type = str[start:end].decode('utf-8')
        else:
          _v86.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v86.points = []
        ...
        if python3:
          _v88.type = str[start:end].decode('utf-8')
        else:
          _v88.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v88.points = []
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v139.type = str[start:end].decode('utf-8')
        else:
          _v139.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v139.points = []
        ...
        if python3:
          _v141.type = str[start:end].decode('utf-8')
        else:
          _v141.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v141.points = []
        ...
        if python3:
          _v143.type = str[start:end].decode('utf-8')
        else:
          _v143.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v143.points = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v158.type = str[start:end].decode('utf-8')
        else:
          _v158.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v158.points = []
        ...
        if python3:
          _v160.type = str[start:end].decode('utf-8')
        else:
          _v160.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v160.points = []
        ...
        if python3:
          _v162.type = str[start:end].decode('utf-8')
        else:
          _v162.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v162.points = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v167.type = str[start:end].decode('utf-8')
        else:
          _v167.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v167.points = []
        ...
        if python3:
          _v169.type = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v171.type = str[start:end].decode('utf-8')
        else:
          _v171.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v171.points = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v176.type = str[start:end].decode('utf-8')
        else:
          _v176.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v176.points = []
        ...
        if python3:
          _v178.type = str[start:end].decode('utf-8')
        else:
          _v178.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v178.points = []
        ...
        if python3:
          _v180.type = str[start:end].decode('utf-8')
        else:
          _v180.type = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v180.points = []

...
class Lanelet(genpy.Message):
  _md5sum = "837810aacbfb44d4517b2e232d66b272"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.left_bound.type = str[start:end].decode('utf-8')
      else:
        self.left_bound.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.right_bound.type = str[start:end].decode('utf-8')
      else:
        self.right_bound.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.centerline.type = str[start:end].decode('utf-8')
      else:
        self.centerline.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])

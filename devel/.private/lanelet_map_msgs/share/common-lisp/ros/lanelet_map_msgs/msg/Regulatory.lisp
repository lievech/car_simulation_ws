...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Regulatory>)))
  ...
  "704d2f9c46d8b54629d0087b8ef05c8c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Regulatory)))
  "Returns md5sum for a message object of type 'Regulatory"
  "704d2f9c46d8b54629d0087b8ef05c8c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Regulatory>)))
  ...
  (cl:format cl:nil "Node[] special_nodes~%Way[] special_ways~%~%================================================================================~%MSG: lanelet_map_msgs/Node~%int32 id~%string type~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: lanelet_map_msgs/Way~%string type~%Node[] points~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Regulatory)))
  "Returns full string definition for message of type 'Regulatory"
  (cl:format cl:nil "Node[] special_nodes~%Way[] special_ways~%~%================================================================================~%MSG: lanelet_map_msgs/Node~%int32 id~%string type~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: lanelet_map_msgs/Way~%string type~%Node[] points~%~%~%"))
